...
def test_basic_pfcwd_various_reboot_scenarios(api,
                                              port_id,
                                              duthost,
                                              prio,
                                              conn_graph_facts,
    ...
    #Step1
    #$sudo warm-reboot [options]
    logger.info("Warm Reboot test")
    reboot(duthost, localhost, reboot_type='warm', wait=120)
    ...
    #Step2
    #sudo fast-reboot
    logger.info("Fast Reboot test")
    reboot(duthost, localhost, reboot_type='fast', wait=120)
    run_basic_pfcwd_all_to_all_test(api=api,
                                port_id=port_id,
                                prio=prio,
                                duthost=duthost,
    ...
    #Step3
    #sudo coldreboot
    logger.info("Cold Reboot test")
    reboot(duthost, localhost, reboot_type='cold', wait=120)
    run_basic_pfcwd_all_to_all_test(api=api,
                                port_id=port_id,
                                prio=prio,
                                duthost=duthost,
